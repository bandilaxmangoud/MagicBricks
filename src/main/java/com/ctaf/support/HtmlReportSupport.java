...
public class HtmlReportSupport {
	...
	public static void createHtmlSummaryReport() throws Exception {
		...
		try {
			...
			writer.write("<title>MagicBricks - Automation Execution Results Summary</title>");
			...
			//writer.write("MagicBricks -  Automation Execution Result Summary ");
			writer.write("Flip Kart -  Automation Execution Result Summary ");
			writer.write("</th> ");
			writer.write("</tr> ");
